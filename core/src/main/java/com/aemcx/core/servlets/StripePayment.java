...
@SlingServletResourceTypes(resourceTypes = "aemcx/components/registrationform", // Resource Type of your Component
		methods = HttpConstants.METHOD_POST, extensions = "html", selectors = "stripePayment" // This can be any
																								// selector you'd like
)
...
public class StripePayment extends SlingAllMethodsServlet {
	...
	// OSGi Service
	@Reference
	private transient StripeApiKey stripeApiKey;
				...
				.addLineItem(SessionCreateParams.LineItem.builder()
						.setPriceData(SessionCreateParams.LineItem.PriceData.builder().setCurrency("usd")
								...
								.setProductData(SessionCreateParams.LineItem.PriceData.ProductData.builder()
										.setName(selectedValue).setDescription(selectedValueDesc).build())
								.build())
						.setQuantity(1L).build())
				.setMode(SessionCreateParams.Mode.PAYMENT).setSuccessUrl(YOUR_DOMAIN + successUrl)
				.setCancelUrl(YOUR_DOMAIN + cancelUrl).build();
		LOGGER.info("abc");
